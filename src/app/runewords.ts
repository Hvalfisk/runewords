...
export const runewords: Runeword[] = [{
  ...
  itemCategories: ['melee', 'ranged', 'shield'],
  level: 65,
  ...
  itemCategories: ['melee', 'ranged', 'armor'],
  level: 59,
